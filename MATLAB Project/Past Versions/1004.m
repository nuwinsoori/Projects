...
for i = 2:6 % starts at 2 since will not need joined cards if only 1 card out 
...
% when dealer drawing 
for i = 2:6
    dealersHandImage{i} = dealersJoinedBotCardImages{i-1} + dealersCardImages{i};
end

disp(dealersHandImage{2});
